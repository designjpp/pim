$(document).ready(function () {
    ...
    let submitPaymentResultForm = document.getElementById(
        "js-submit-payment-result"
    );
    ...
    ccForm.addEventListener("submit", function (event) {
        ...
        Card.createResource().then(successHandler).catch(errorHandler);
    });
    ...
    $("#js-redirect-payment-method-paypal").on("click", function (e) {
        ...
        Paypal.createResource().then(successHandler).catch(errorHandler);
    });
    ...
    $("#js-redirect-payment-method-paypal-sofort").on("click", function (e) {
        ...
        Sofort.createResource().then(successHandler).catch(errorHandler);
    });
});
