...
new Vue({
        ...
        filterListing: function () {
            ...
            if (this.filters.fromDate) {
                var fromTimeStamp = +new Date(
                    this.filters.fromDate.setHours(0, 0, 0, 0) / 1000
                );
                filters.fromDate = {
                    $gte: fromTimeStamp,
                };
            ...
            if (this.filters.toDate) {
                var toTimeStamp = +new Date(
                    this.filters.toDate.setHours(23, 59, 59, 999) / 1000
                );
                filters.toDate = {
                    $lte: toTimeStamp,
                };
    ...
    computed: {
        ...
        mapCoordinates: function () {
            return [
                this.eventDetails.locationMap.latitude,
                this.eventDetails.locationMap.longitude,
            ];
        },
    },
});
